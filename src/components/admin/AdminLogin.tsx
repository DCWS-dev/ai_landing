      ...
      <div className="card-glass rounded-2xl p-8 max-w-sm w-full">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            ...
            className="w-full py-3 rounded-xl bg-accent text-surface font-bold hover:bg-accent-light transition-colors disabled:opacity-50 cursor-pointer flex items-center justify-center gap-2"
          >
            {loading ? (
              <>
